...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available Zoot skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a Zoot skill."),
    ...
    SlashCommand("exit", "/exit", "Exit Zoot.", ("quit",)),
)
...
def command_help_text() -> str:
    ...
    for command in SLASH_COMMANDS:
        lines.append(f"{command.usage:<34} {command.description}")
    lines.append("```")
    return "\n".join(lines)
