...
SKILL_FILE_CREATION_GUIDE = """When creating Zoot skill files at .zoot/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${ZOOT_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".zoot" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".zoot" / "skills", "project"),
    ]
