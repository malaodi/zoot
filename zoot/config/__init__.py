...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "zoot" / "config.toml"
PROJECT_CONFIG_NAME = ".zoot.toml"
...
ENV_PROVIDER = "ZOOT_PROVIDER"
ENV_API_KEY = "ZOOT_API_KEY"
ENV_BASE_URL = "ZOOT_BASE_URL"
ENV_MODEL = "ZOOT_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("ZOOT_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("ZOOT_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("ZOOT_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
            "ZOOT_ANTHROPIC_API_KEY",
            "ANTHROPIC_API_KEY",
            "ZOOT_RIGHT_CODES_API_KEY",
            "RIGHT_CODES_API_KEY",
            "ZOOT_OPENAI_API_KEY",
            "OPENAI_API_KEY",
        ),
        "base_url": (
            "ZOOT_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("ZOOT_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("ZOOT_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "ZOOT_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("ZOOT_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("ZOOT_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("ZOOT_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid Zoot config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read Zoot config file {path}: {exc}") from exc
