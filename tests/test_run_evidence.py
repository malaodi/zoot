...
def test_run_evidence_reads_trace_report_and_session_artifacts(tmp_path):
    workspace = tmp_path
    run_dir = workspace / ".zoot" / "runs" / "run_1"
    session_dir = workspace / ".zoot" / "sessions"
        ...
        json.dumps(
            {
                ...
                "runtime_reminders": [{"artifact_path": ".zoot/runs/run_1/artifacts/fallback.txt"}],
                ...
                json.dumps(
                    {
                        "event": "tool_executed",
                        "name": "run_shell",
                        "full_output_artifact": ".zoot/runs/run_1/artifacts/output.txt",
                    }
                ),
    ...
    assert evidence.full_output_artifacts() == [
        ".zoot/runs/run_1/artifacts/output.txt",
        ".zoot/runs/run_1/artifacts/fallback.txt",
    ]
