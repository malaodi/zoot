...
from zoot.evaluation.metrics import (  # noqa: E402
...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Run zoot large-scale experiments and write all experiment artifacts.")
